defmodule StellarWeb.Auth.Guardian do
  ...
  """
  def after_encode_and_sign(_resource, _claims, token, _opts) do
    {:ok, token}
  end
  ...
  """
  def on_verify(claims, _token, _opts) do
    {:ok, claims}
  end

  @doc """
  Called on token refresh - revokes the old token.
  """
  ...
  """
  def on_revoke(claims, _token, _opts) do
